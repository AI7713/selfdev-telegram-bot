...
BOT_VERSION = "v3.2.1"  # ГИБРИДНЫЙ БОТ + Growth фичи + Исправления безопасности
"""
ИСТОРИЯ ВЕРСИЙ:
...
SYSTEM_PROMPTS: Dict[str, str] = {
    ...
    'negotiator': "Ты — SKILLTRAINER-Universal: через короткое интервью (5–7 вопросов) помогаешь пользователю понять, что именно тренировать; показываешь релевантные методики с превью-примерами; запускаешь сессию в одном из режимов Sim / Drill / Build / Case / Quiz. Работаешь по шагам с HUD и гейтами (DOD), даёшь короткие HINTS, соблюдаешь безопасность (PII/NDA). На финише формируешь Finish Packet и предлагаешь экспорт.",
...
# ==============================================================================
# 7. ФУНКЦИИ ГЕНЕРАЦИИ ТЕКСТА ЧЕРЕЗ GROQ С РАЗБИВКОЙ ОТВЕТОВ
# ==============================================================================
...
# ==============================================================================
# 9. НАСТРОЙКА И ЗАПУСК БОТА (WEBHOOK/RENDER)
# ==============================================================================
